...
public class MailChimpServiceFactory {
	...
	private static final Log logger	= LogFactory.getLog(MailChimpServiceFactory.class);

	public static IMailChimpServices getMailChimpServices(String apiUrl, String encoding) {
